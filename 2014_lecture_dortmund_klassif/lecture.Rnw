...
\begin{frame}
  ...
  \begin{block}{}
    \begin{itemize}
      ...
      \item Parallelization through parallelMap (local, socket, MPI and BatchJobs modes)
        \begin{itemize}
...
\begin{frame}
  ...
  \begin{block}{}
  \begin{center}\begin{Large}
  ex4.R: Basic tuning: grid search
  \end{Large}\end{center}
\end{block}
...
\begin{frame}
  ...
  \begin{block}{}
  \begin{center}\begin{Large}
  ex5.R: Tuning + nested resampling via wrappers
  \end{Large}\end{center}
\end{block}
